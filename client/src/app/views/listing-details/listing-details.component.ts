...
export class ListingDetailsComponent {
  amenities = [
    ...
    { icon: 'bi bi-broom', text: 'Daglig städning' },
    ...
    { icon: 'bi bi-coins', text: 'Gratis parkering' },
    { icon: 'bi bi-lightbulb', text: 'Energisnål belysning' },
    { icon: 'bi bi-rain', text: 'Regnvattenåtervinning' },
    ...
    { icon: 'bi bi-glasses', text: 'Gratis solglasögon' },
    ...
    { icon: 'bi bi-paw', text: 'Husdjur tillåtna' },
